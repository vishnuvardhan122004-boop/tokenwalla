...
- **Branch:** clean — everything merged. Web/backend PRs **#44, #45, #46** (the scan stack) and app PR **#15** all landed 2026-08-19; this wrap is on `docs/wrap-2026-08-19`. **Do NOT delete** `develop` (deploys to staging), `harden-password-validators` or `website-cleanup-eslint-deadDep` — the last two look dead but hold unmerged work.
