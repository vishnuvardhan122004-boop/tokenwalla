      ...
      <div className="auth-wrap">
        ...
        <div className="auth-left">
          ...
          <div className="auth-left-content">
            ...
            <div className="auth-left-label">Patient Login</div>
            <h1 className="auth-left-title">
              Welcome<br />
              <span>Back!</span>
            </h1>
            <p className="auth-left-sub">
              Log in to view your bookings, track your queue position,
              and book new doctor appointments instantly.
            </p>

            <div className="auth-features">
              {[
                { icon: '🎫', title: 'Instant Token',     desc: 'Get your token number immediately after booking' },
        ...
        <div className="auth-right">
          ...
          <div className="auth-switch">
            ...
            <Link to="/profilecreate">Create one free →</Link>
          </div>
          <Link to="/forgot-password" style={{ color:'#00D4FF', fontSize:13, display:'block', textAlign:'right', marginTop:4 }}>
          Forgot Password?
          </Link>
          ...
          <div style={{ marginTop: 32, paddingTop: 24, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.25)', textAlign: 'center', lineHeight: 1.6 }}>
              Are you a hospital?{' '}
              <Link to="/Hlogin" style={{ color: 'rgba(255,255,255,0.45)', textDecoration: 'none' }}>
                Hospital Login →
              </Link>
            </div>
          </div>
