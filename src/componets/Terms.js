  ...
  return (
    <div className="container py-5" style={{ maxWidth: 760, fontFamily: 'DM Sans, sans-serif' }}>
      ...
      {[
        ...
        { title: '5. Payments', body: 'All payments are processed via Cashfree. Orders are confirmed only after successful payment. TokenWalla does not store card details.' },
        { title: '6. KYC & verification', body: 'By using TokenWalla, you consent to provide identity documents as required by TokenWalla, Cashfree, or regulatory authorities to comply with RBI guidelines and anti-money laundering regulations.' },
